...
@Tag(
    name = "Profile & Resume",
    description = "Upload, view, update, and download user profiles and resumes")
public class ChatBotController {
  ...
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "Resume parsed and profile saved successfully"),
  ...
  @Operation(
      ...
      description =
          "Returns the authenticated user's profile fields including the parsed resume JSON.")
  @ApiResponses({
  ...
  @Operation(
      summary = "Download resume PDF by profile ID",
      description = "Returns the stored resume PDF as a downloadable binary file.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      summary = "Download current user's resume PDF",
      description = "Returns the authenticated user's stored resume PDF as a downloadable file.")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "PDF file returned",
  ...
  @io.swagger.v3.oas.annotations.parameters.RequestBody(
      description = "Resume update payload",
      required = true,
      content =
          @Content(
              mediaType = "application/json",
  ...
  public ResponseEntity<?> updateResume(@RequestBody Map<String, Object> request) {
    ...
    return ResponseEntity.ok(Map.of("message", "Resume updated successfully", "profile", profile));
  }
  ...
  @Operation(
      ...
      description = "Returns the profile of any user by their profile ID.")
  @ApiResponses({
  ...
  private ResponseEntity<byte[]> buildPdfResponse(JsonData data) {
    ...
    return ResponseEntity.ok().headers(headers).body(data.getResumePdf());
  }
