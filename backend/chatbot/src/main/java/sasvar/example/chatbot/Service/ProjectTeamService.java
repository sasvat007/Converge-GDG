...
public class ProjectTeamService {
  ...
  @Autowired private ProjectTeamRequestRepository projectTeamRequestRepository;
  ...
  public ProjectTeamRequest createTeammateRequest(Long projectId, String targetEmail) {
    ...
    var existing =
        projectTeamRequestRepository.findByProjectIdAndTargetEmailAndStatus(
            projectId, targetEmail, "PENDING");
  ...
  public ProjectTeam acceptTeammateRequest(Long requestId) {
    ...
    ProjectTeamRequest req =
        projectTeamRequestRepository
            .findById(requestId)
    ...
    for (JsonData raterProfile : memberProfiles) { // The person who will be rating
      for (JsonData rateeProfile : memberProfiles) { // The person being rated
        if (!raterProfile.getEmail().equals(rateeProfile.getEmail())) {
          ...
          ratingRequest.setTargetEmail(
              raterProfile.getEmail()); // The user who needs to perform the rating
